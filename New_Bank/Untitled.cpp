...
class hashTable {
	...
	public:
		...
		void init (int size);
		unsigned long long insert (int, T);
		T& operator [] (int);
...
template <class T>
unsigned long long hashTable<T>::insert (int key, T value) {
	this->usedSlots ++;
